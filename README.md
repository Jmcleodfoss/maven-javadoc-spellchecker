...
1. * spchk.doclet.path: path-to-SpellCheckDoclet
1. * spchk.jazzy.path: path-to-Jazzy
1. * spchk.user.ignoreFile: path-and-filename-for-user-ignore-list.txt
1. * spchk.project.ignoreFile: path-and-filename-for-project-ignore-word-list.txt
